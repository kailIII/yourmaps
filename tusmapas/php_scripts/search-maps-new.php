...
?>	
		...
		<body>
			...
			<div class="container"> 
				<div class="span-24 last" id="search-box">
...
<!--						<gcse:searchbox-only resultsUrl="http://www.lookingformaps.com/mapsfoundbykeyword.php" newWindow="false" queryParameterName="keywords">-->
				...
				<div class="span-8 " id="introduction">
					
					<p style="text-shadow: 1px 1px 2px #90BADD;">
					<a href="http://www.lookingformaps.com">www.lookingformaps.com</a> es una aplicación en internet para buscar mapas de la misma forma que buscas con Google.
					</p>
					<hr class="space"></hr>
					<p >
